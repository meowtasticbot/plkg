...
from Meowstric.plugins.voice import voice_command
...
from Meowstric.plugins.couple import couple
from Meowstric.plugins.social import help_command, love_command
...
async def button_handler(update, context):
    ...
    data = query.data or ""
    start_callbacks = {"return_start", "talk_baka", "show_features", "game_features"}
